 Flight Instruments jQuery Plugin
===================

This plugin allows you to display high quality flight indicators using HTML, CSS3, jQuery and SVG images. The methods make customization and real time implementation really easy. Further, since all the images are vector svg you can resize the indicators without any quality loss!
...
![demo_highres](./docs/move_path.png "move_path woes")
